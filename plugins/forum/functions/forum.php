...
function forum_get_sub_replies($thread_id, $replied_id, $page, $limit){
    $db = db();
    $query = "SELECT id, post, replier_id, thread_id, date FROM forum_replies WHERE replied_id = ".mysqli_real_escape_string(db(), $replied_id)."  AND thread_id = ".mysqli_real_escape_string(db(), $thread_id);
