...
register_pager("helps", array('use' => 'help::help@help_pager'));
register_pager("help/{slugs}", array('use' => 'help::help@help_page_pager'))->where(array('slugs' => '[a-zA-Z0-9\-\_]+'));
register_pager("help/{slugs}/{slugs}", array('use' => 'help::help@help_page_pager'))->where(array('slugs' => '[a-zA-Z0-9\-\_]+'));
