...
function suggest_mail_users(t) {
    var i = $(t);
    $.ajax({
        url : baseUrl + 'user/tag/suggestion?term=' + i.val(),
...
function initRichEditor() {
    tinymce.init({
        ...
        toolbar: 'styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist table forecolor code | link image'
    });
}
...
$(function() {
    ...
    if ($('#charts-stats').length > 0) {
        ...
        $.ajax({
            url : baseUrl + 'admincp/load/statistics/?type=chart&year=' + year,
            success : function(data) {
    ...
    if ($('#server-stats').length > 0) {
        $.ajax({
            url : baseUrl + 'admincp/load/statistics/?type=server',
            success : function(data) {
                var json = jQuery.parseJSON(data);
    ...
    function sortablePageBlocks() {
        $('#page-blocks-droppable').sortable({
            ...
            update : function(e, ui) {
                ...
                $.ajax({
                    url : baseUrl + "admincp/block/sort",
                    type : 'POST',
    ...
    $("#page-blocks-droppable").droppable({
        ...
        drop : function(event, ui) {
            ...
            $.ajax({
                url : baseUrl + "admincp/block/register",
                type : 'POST',
    ...
    $(document).on('click', '#page-blocks-droppable .delete-button', function() {
        ...
        $.ajax({
            url : baseUrl + "admincp/block/remove",
            type : 'POST',
    ...
    $('.custom-field-list').each(function() {
        ...
        $(this).sortable({
            ...
            update : function(e, ui) {
                ...
                $.ajax({
                    url : baseUrl + "admincp/custom-fields?action=order",
                    type : 'POST',
...
var siteEditor = {
    ...
    changePage : function(t) {
        ...
        $.ajax({
            url : baseUrl + 'admincp/site/layout/page?page=' + page,
            success: function(data) {
                container.html(data);
    ...
    loadWidgetSettings : function(t, id, widget) {
        ...
        m.modal('toggle');
        $.ajax({
            url : baseUrl + 'admincp/site/editor/widget/settings/load',
    ...
    editPageInfo : function() {
        ...
        if (currentPage != 'footer' && currentPage != 'header') {
            ...
            indicator.fadeIn();
            $.ajax({
                url: baseUrl + 'admincp/site/editor/page/info?id=' + currentPage,
                success: function(data) {
                    c.html(data);
                    indicator.hide();
    ...
    addMenu : function(title,link,icon,type,ajax,tab,id) {
        ...
        $.ajax({
            url : baseUrl + 'admincp/site/editor/menu/add',
    ...
    deleteMenu : function(id) {
        ...
        menu.hide().remove();
        $.ajax({
            url : baseUrl + "admincp/site/editor/menu/delete",
    ...
    editMenu : function(id) {
        ...
        modal.modal('toggle');
        $.ajax({
            url : baseUrl + 'admincp/site/editor/menu/edit?id=' + id,
            success : function(data) {
                content.html(data);
                loader.hide();
            }
    ...
    changeMenu : function(t) {
        ...
        $.ajax({
            url : baseUrl + 'admincp/site/editor/menu/change?location=' + location,
            success : function(data) {
                container.html(data);
                siteEditor.reloadInit();
            }
    ...
    reloadInit : function() {
        ...
        $('#menu-location-items').sortable({
            ...
            update : function(e, ui) {
                ...
                var location= $('#menu-locations').val();
                $.ajax({
                    url : baseUrl + "admincp/site/editor/menu/sort",
                    type : 'POST',
