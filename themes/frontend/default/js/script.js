...
function reloadInits() {
    ...
    if($(window).width() > 1000) {
        //$('.middle-container .right-col-content').trigger('sticky_kit:detach');
        //$('.middle-container .left-col-content').trigger('sticky_kit:detach');
        $(document.body).trigger("sticky_kit:recalc");
        if ($(".profile-container").length > 0) {
            //$('.profile-container .middle-container .right-col-content').stick_in_parent({offset_top:490,bottoming:false,parent:$(".middle-container")});
            //$('.profile-container .middle-container .left-col-content').stick_in_parent({offset_top:490,bottoming:false,parent:$(".middle-container")});
        } else {
