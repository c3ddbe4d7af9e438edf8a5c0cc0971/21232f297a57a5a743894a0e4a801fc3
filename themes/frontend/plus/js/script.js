...
function reloadInits() {
    ...
    if($(window).width() > 1000) {
        if ($(".profile-container").length > 0) {
            $('.middle-container .right-col-content').stick_in_parent({offset_top: 200,bottoming:false,parent:$(".middle-container")});
            $('.middle-container .left-col-content').stick_in_parent({offset_top:200,bottoming:false,parent:$(".middle-container")});

        } else {
            //$('.right-column').stick_in_parent({offset_top: 90,bottoming:false,parent:$("#main-wrapper")});
            $('.middle-container .right-col-content').stick_in_parent({offset_top: 90,bottoming:false,parent:$(".middle-container")});
            $('.middle-container .left-col-content').stick_in_parent({offset_top: 90,bottoming:false,parent:$(".middle-container")});
        }
